    ...
    def _context(
        ...
        *,
        ...
        return {
            ...
            "guide_note": (
                "本导读由 DeepSeek 生成，仅供阅读辅助；筛选、评分与排序仍由透明规则完成。"
                if guide_zh
                else (
                    "This guide is generated by DeepSeek for reading convenience only; "
                    "screening, scoring, and ranking are still done by transparent rules."
                )
            ),
        }
